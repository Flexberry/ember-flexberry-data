# Миграция: model/app/models/model-without-validation.js
...
- `app/lib/types/$(echo app-models-model-without-validation.js | cut -d. -f1 | sed s/app-//g)-custom.ts` — кастомный interface
...
```typescript
// app/lib/types/$(echo app-models-model-without-validation.js | cut -d. -f1 | sed s/app-//g)-custom.ts
