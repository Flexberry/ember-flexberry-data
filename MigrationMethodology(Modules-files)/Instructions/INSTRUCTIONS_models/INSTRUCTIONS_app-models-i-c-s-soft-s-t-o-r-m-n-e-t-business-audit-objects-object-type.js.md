# Миграция: model/app/models/i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-object-type.js
...
- `app/lib/types/$(echo app-models-i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-object-type.js | cut -d. -f1 | sed s/app-//g)-custom.ts` — кастомный interface
...
```typescript
// app/lib/types/$(echo app-models-i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-object-type.js | cut -d. -f1 | sed s/app-//g)-custom.ts
