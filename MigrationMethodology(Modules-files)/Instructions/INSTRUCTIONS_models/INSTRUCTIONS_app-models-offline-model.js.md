# Миграция: model/app/models/offline-model.js
...
- `app/lib/types/$(echo app-models-offline-model.js | cut -d. -f1 | sed s/app-//g)-custom.ts` — кастомный interface
...
```typescript
// app/lib/types/$(echo app-models-offline-model.js | cut -d. -f1 | sed s/app-//g)-custom.ts
