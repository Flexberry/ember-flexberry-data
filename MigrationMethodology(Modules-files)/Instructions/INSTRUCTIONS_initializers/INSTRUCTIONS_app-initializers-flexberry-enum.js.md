# Миграция: initializer/app/initializers/flexberry-enum.js
...
export default {
  name: '$(echo app-initializers-flexberry-enum.js | cut -d. -f1 | sed s/app-//g)',
  initialize,
};
```

### 2. Целевой файл (Next.js 16)
- `app/lib/setup/$(echo app-initializers-flexberry-enum.js | cut -d. -f1 | sed s/app-//g)-custom.ts` — кастомная function
...
```typescript
// app/lib/setup/$(echo app-initializers-flexberry-enum.js | cut -d. -f1 | sed s/app-//g)-custom.ts
