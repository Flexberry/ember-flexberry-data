# Миграция: service/app/services/offline-globals.js
...
- `app/lib/contexts/$(echo app-services-offline-globals.js | cut -d. -f1)-custom.tsx` — кастомный Context
...
```typescript
// app/lib/contexts/$(echo app-services-offline-globals.js | cut -d. -f1 | sed s/app-//g)-custom.tsx
