# Миграция: service/app/services/syncer.js
...
- `app/lib/contexts/$(echo app-services-syncer.js | cut -d. -f1)-custom.tsx` — кастомный Context
...
```typescript
// app/lib/contexts/$(echo app-services-syncer.js | cut -d. -f1 | sed s/app-//g)-custom.tsx
