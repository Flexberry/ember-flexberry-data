# Миграция: serializer/app/serializers/i-c-s-soft-s-t-o-r-m-n-e-t-security-link-group.js
...
- `app/lib/transforms/$(echo app-serializers-i-c-s-soft-s-t-o-r-m-n-e-t-security-link-group.js | cut -d. -f1 | sed s/app-//g)-custom.ts` — кастомная function
...
```typescript
// app/lib/transforms/$(echo app-serializers-i-c-s-soft-s-t-o-r-m-n-e-t-security-link-group.js | cut -d. -f1 | sed s/app-//g)-custom.ts
