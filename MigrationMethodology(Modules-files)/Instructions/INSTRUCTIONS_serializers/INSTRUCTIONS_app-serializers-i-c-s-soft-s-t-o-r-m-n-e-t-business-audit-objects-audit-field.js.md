# Миграция: serializer/app/serializers/i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-audit-field.js
...
- `app/lib/transforms/$(echo app-serializers-i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-audit-field.js | cut -d. -f1 | sed s/app-//g)-custom.ts` — кастомная function
...
```typescript
// app/lib/transforms/$(echo app-serializers-i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-audit-field.js | cut -d. -f1 | sed s/app-//g)-custom.ts
