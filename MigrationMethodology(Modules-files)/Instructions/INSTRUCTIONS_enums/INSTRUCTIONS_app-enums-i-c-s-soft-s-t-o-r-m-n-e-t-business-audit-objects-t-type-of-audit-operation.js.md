# Миграция: enum/app/enums/i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-t-type-of-audit-operation.js
...
- `app/lib/enums/$(echo app-enums-i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-t-type-of-audit-operation.js | cut -d. -f1 | sed s/app-//g)-custom.ts` — кастомный const
...
```typescript
// app/lib/enums/$(echo app-enums-i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-t-type-of-audit-operation.js | cut -d. -f1 | sed s/app-//g)-custom.ts
export const *Custom = {
  // Кастомные значения
} as const;
```
