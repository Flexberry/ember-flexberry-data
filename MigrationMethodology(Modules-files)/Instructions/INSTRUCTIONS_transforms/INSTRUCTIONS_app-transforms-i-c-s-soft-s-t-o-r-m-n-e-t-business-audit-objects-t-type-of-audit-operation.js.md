# Миграция: transform/app/transforms/i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-t-type-of-audit-operation.js
...
- `app/lib/transforms/$(echo app-transforms-i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-t-type-of-audit-operation.js | cut -d. -f1 | sed s/app-//g)-custom.ts` — кастомная function
...
```typescript
// app/lib/transforms/$(echo app-transforms-i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-t-type-of-audit-operation.js | cut -d. -f1 | sed s/app-//g)-custom.ts
