...
- `app/lib/transforms/i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-t-execution-variant.ts`
...
2. Создать файл с функцией `transformIcsSoftStormNetBusinessAuditObjectsTExecutionVariant`
...
/**
 * Трансформация ExecutionVariant для Ember Data → Next.js
 * @param value - значение для трансформации
 * @param toBackend - признак направления: true = в Backend, false = из Backend
 * @returns преобразованное значение
 */
export function transformIcsSoftStormNetBusinessAuditObjectsTExecutionVariant(
  value: unknown,
...
- [ ] Файл создан с функцией `transformIcsSoftStormNetBusinessAuditObjectsTExecutionVariant`
